...
public class DesktopApplication2View extends FrameView {
    ...
    public void newRecord() {
        desktopapplication2.Manufacturer m = new desktopapplication2.Manufacturer();
    ...
    public void deleteRecord() {
        ...
        List<desktopapplication2.Manufacturer> toRemove = new ArrayList<desktopapplication2.Manufacturer>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            desktopapplication2.Manufacturer m = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(m);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<desktopapplication2.Manufacturer> merged = new ArrayList<desktopapplication2.Manufacturer>(list.size());
                for (desktopapplication2.Manufacturer m : list) {
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${rep}"));
        columnBinding.setColumnName("Rep");
        columnBinding.setColumnClass(String.class);
        bindingGroup.addBinding(jTableBinding);

        masterScrollPane.setViewportView(masterTable);

        manufacturerIdLabel.setText(resourceMap.getString("manufacturerIdLabel.text")); // NOI18N
        manufacturerIdLabel.setName("manufacturerIdLabel"); // NOI18N
        ...
        repLabel.setText(resourceMap.getString("repLabel.text")); // NOI18N
        repLabel.setName("repLabel"); // NOI18N

        manufacturerIdField.setName("manufacturerIdField"); // NOI18N

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.manufacturerId}"), manufacturerIdField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        repField.setName("repField"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.rep}"), repField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), repField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(manufacturerIdField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    ...
                    .addComponent(repField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(mainPanelLayout.createSequentialGroup()
                .addContainerGap()
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(manufacturerIdLabel)
                    .addComponent(manufacturerIdField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(nameLabel)
    ...
    private java.util.List<desktopapplication2.Manufacturer> list;
