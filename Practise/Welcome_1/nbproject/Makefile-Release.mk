...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/None-Windows/welcome_1.exe

dist/Release/None-Windows/welcome_1.exe: ${OBJECTFILES}
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/None-Windows/welcome_1.exe
